function BCI_feedback_task_auditory_v1()
...
% Info.electrode_locs = 'M:\Analysis\Entrainment\tACS\Vamp_18chan_montage25.ced'; %18 channel V-Amp
Info.electrode_locs = 'M:\Analysis\ElectrodeLocs\EOG-electrode-locs-32.ced'; %32 channel passive electrodes brain amp
% Info.electrode_locs = 'M:\Analysis\ElectrodeLocs\EOG-electrode-locs.ced'; %18 channel active electrodes V-Amp
% Info.electrode_locs = 'M:\Analysis\ElectrodeLocs\BrainAMP_16_Chan.ced'; %18 channel brain amp
...
%for 32 chan brain amp
Info.n_elect = 2:32; %list of every electrode collecting brain data
Info.refelec = 1; %which electrode do you want to re-reference to?
Info.eogelec = 33:34; %list all the EOGs
%//////////////////////////////////////////////////////////////////////////
